...
.method static constructor <clinit>()V
    ...
    sput-object v0, Ltms/dz;->a:Ljava/lang/reflect/Method;

    sget-object v0, Ltms/dz;->a:Ljava/lang/reflect/Method;
    ...
    sput-object v0, Ltms/dz;->b:Ljava/lang/reflect/Method;

    sget-object v0, Ltms/dz;->b:Ljava/lang/reflect/Method;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Ltms/dz;->d:Landroid/content/Context;

    iget-object v0, p0, Ltms/dz;->d:Landroid/content/Context;

    invoke-virtual {v0}, Landroid/content/Context;->getPackageManager()Landroid/content/pm/PackageManager;

    move-result-object v0

    iput-object v0, p0, Ltms/dz;->e:Landroid/content/pm/PackageManager;
    ...
    iput-object v0, p0, Ltms/dz;->f:Landroid/app/ActivityManager;
...
.method public clearAllCacheData()Z
    ...
    invoke-direct {p0}, Ltms/dz;->a()J

    move-result-wide v3

    new-instance v0, Ltms/ea;

    invoke-direct {v0, p0, v2, v1}, Ltms/ea;-><init>(Ltms/dz;Ljava/util/concurrent/atomic/AtomicBoolean;Ljava/lang/Object;)V

    :try_start_0
    sget-object v5, Ltms/dz;->a:Ljava/lang/reflect/Method;
    ...
    iget-object v6, p0, Ltms/dz;->e:Landroid/content/pm/PackageManager;
...
.method public clearCacheData(Ljava/lang/String;)Z
    .locals 1
...
.method public getAllAppPackageStats(Ljava/util/List;)Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, v0}, Ltms/dz;->getAppPackageStats(Ljava/lang/String;)Landroid/content/pm/PackageStats;
...
.method public getAppPackageStats(Ljava/lang/String;)Landroid/content/pm/PackageStats;
    ...
    invoke-direct {v0, p0, v2, v1}, Ltms/eb;-><init>(Ltms/dz;Ljava/util/concurrent/atomic/AtomicReference;Ljava/lang/Object;)V

    :try_start_0
    sget-object v3, Ltms/dz;->b:Ljava/lang/reflect/Method;
    ...
    iget-object v4, p0, Ltms/dz;->e:Landroid/content/pm/PackageManager;
...
.method public getFreeMemery()J
    ...
    iget-object v1, p0, Ltms/dz;->f:Landroid/app/ActivityManager;
...
.method public getRamSize([Ljava/lang/String;)[Landroid/os/Debug$MemoryInfo;
    .locals 9

    const/4 v1, 0x0

    iget-object v0, p0, Ltms/dz;->f:Landroid/app/ActivityManager;
