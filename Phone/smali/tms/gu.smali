...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Ltms/gu;->c:Ljava/lang/String;
    ...
    iput-object v0, p0, Ltms/gu;->d:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Ltms/gu;->f:Ljava/util/HashMap;
...
.method private a(Lcom/tencent/tmsecure/module/update/UpdateInfo;)V
    ...
    iget-object v0, p0, Ltms/gu;->b:Landroid/content/Context;
    ...
    iget-object v0, p1, Lcom/tencent/tmsecure/module/update/UpdateInfo;->data1:Ljava/lang/Object;

    check-cast v0, LQQPIM/ConfSrc;

    iget v2, v0, LQQPIM/ConfSrc;->isincreupdate:I
    ...
    iget-object v3, p0, Ltms/gu;->c:Ljava/lang/String;
    ...
    iget-object v3, p1, Lcom/tencent/tmsecure/module/update/UpdateInfo;->fileName:Ljava/lang/String;
    ...
    invoke-virtual {v0}, LQQPIM/ConfSrc;->getIuchecksum()Ljava/lang/String;

    move-result-object v0

    invoke-virtual {v1, v2, v0}, Lcom/tencent/tccdb/TelNumberLocator;->patchLocation(Ljava/lang/String;Ljava/lang/String;)I

    :cond_0
    invoke-virtual {v1}, Lcom/tencent/tccdb/TelNumberLocator;->reload()V
...
.method private b(I)Ljava/lang/String;
    ...
    iget-object v2, p0, Ltms/gu;->c:Ljava/lang/String;
    ...
    iget-object v2, p0, Ltms/gu;->b:Landroid/content/Context;

    iget-object v3, p0, Ltms/gu;->c:Ljava/lang/String;

    invoke-static {v2, v0, v3}, Ltms/s;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    :cond_0
    return-object v1
.end method

.method private b(ILcom/tencent/tmsecure/module/update/ICheckListener;)V
    .locals 1

    if-eqz p1, :cond_0

    invoke-interface {p2, p1}, Lcom/tencent/tmsecure/module/update/ICheckListener;->onCheckEvent(I)V

    :cond_0
    const/4 v0, 0x0

    invoke-interface {p2, v0}, Lcom/tencent/tmsecure/module/update/ICheckListener;->onCheckFinished(Lcom/tencent/tmsecure/module/update/CheckResult;)V

    return-void
.end method

.method private b(Lcom/tencent/tmsecure/module/update/UpdateInfo;)V
    .locals 5

    iget-object v2, p0, Ltms/gu;->f:Ljava/util/HashMap;

    monitor-enter v2

    :try_start_0
    iget-object v0, p0, Ltms/gu;->f:Ljava/util/HashMap;
...
.method private c()I
    ...
    iget-object v1, p0, Ltms/gu;->b:Landroid/content/Context;

    invoke-direct {p0, v4}, Ltms/gu;->b(I)Ljava/lang/String;

    move-result-object v2

    invoke-static {v1, v2}, Lcom/tencent/tmsecure/utils/UpdateUtil;->getVirusClientInfo(Landroid/content/Context;Ljava/lang/String;)LQQPIM/VirusClientInfo;
    ...
    invoke-virtual {v1, v0}, LQQPIM/VirusClientInfo;->setEngine_version(I)V
    ...
    iget-object v3, p0, Ltms/gu;->e:Lcom/tencent/tmsecure/module/wupsession/WupSessionManager;

    invoke-virtual {v3, v1, v0, v2}, Lcom/tencent/tmsecure/module/wupsession/WupSessionManager;->getVirusInfos(LQQPIM/VirusClientInfo;Ljava/util/concurrent/atomic/AtomicReference;Ljava/util/ArrayList;)I
    ...
    invoke-virtual {v0}, LQQPIM/VirusServerInfo;->getBUpdate()Z
    ...
    iget-object v4, p0, Ltms/gu;->b:Landroid/content/Context;

    invoke-static {v4, v3, v0, v2}, Lcom/tencent/tmsecure/module/qscanner/AmScanner;->updateBase(Landroid/content/Context;Ljava/lang/String;LQQPIM/VirusServerInfo;Ljava/util/List;)I
...
.method public a()V
    ...
    iget-object v0, p0, Ltms/gu;->d:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public a(I)V
    ...
    iget-object v1, p0, Ltms/gu;->f:Ljava/util/HashMap;
...
.method public a(ILcom/tencent/tmsecure/module/update/ICheckListener;)V
    .locals 11
    ...
    invoke-direct {p0, v2, v3}, Ltms/gu;->b(ILcom/tencent/tmsecure/module/update/ICheckListener;)V
    ...
    invoke-direct {p0, v9}, Ltms/gu;->b(I)Ljava/lang/String;
    ...
    iget-object v4, p0, Ltms/gu;->e:Lcom/tencent/tmsecure/module/wupsession/WupSessionManager;
    ...
    :cond_a
    invoke-direct {p0, v4, v3}, Ltms/gu;->b(ILcom/tencent/tmsecure/module/update/ICheckListener;)V
...
.method public a(ILcom/tencent/tmsecure/module/update/IUpdateObserver;)V
    .locals 4
...
.method public a(Ljava/util/List;Lcom/tencent/tmsecure/module/update/IUpdateListener;)V
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v1, p0, Ltms/gu;->d:Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-virtual {v1, v0}, Ljava/util/concurrent/atomic/AtomicBoolean;->set(Z)V

    new-instance v2, Lcom/tencent/tmsecure/module/update/IUpdateListener$UpdateListener;

    invoke-direct {v2, p2}, Lcom/tencent/tmsecure/module/update/IUpdateListener$UpdateListener;-><init>(Lcom/tencent/tmsecure/module/update/IUpdateListener;)V

    invoke-virtual {v2}, Lcom/tencent/tmsecure/module/update/IUpdateListener$UpdateListener;->onUpdateStarted()V

    invoke-static {}, Ltms/f;->a()Ltms/f;

    move-result-object v1

    invoke-virtual {v1}, Ltms/f;->b()Z

    move-result v1

    if-nez v1, :cond_0

    invoke-virtual {v2}, Lcom/tencent/tmsecure/module/update/IUpdateListener$UpdateListener;->onUpdateFinished()V
    ...
    invoke-virtual {v2}, Lcom/tencent/tmsecure/module/update/IUpdateListener$UpdateListener;->onUpdateCanceled()V
    ...
    const-string v0, "UpdateManagerImpl"

    new-instance v4, Ljava/lang/StringBuilder;

    invoke-direct {v4}, Ljava/lang/StringBuilder;-><init>()V

    const-string v5, "WARNING! null UpdateInfo at "
    ...
    invoke-static {v0, v4}, Lcom/tencent/tmsecure/utils/Log;->f(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-virtual {v2, v0, v4}, Lcom/tencent/tmsecure/module/update/IUpdateListener$UpdateListener;->onProgressChanged(Lcom/tencent/tmsecure/module/update/UpdateInfo;I)V

    :goto_2
    iget v4, v0, Lcom/tencent/tmsecure/module/update/UpdateInfo;->flag:I

    const/16 v5, 0x8

    if-ne v4, v5, :cond_7

    invoke-direct {p0}, Ltms/gu;->c()I
    ...
    invoke-direct {p0, v0}, Ltms/gu;->b(Lcom/tencent/tmsecure/module/update/UpdateInfo;)V
    ...
    iget-object v4, v0, Lcom/tencent/tmsecure/module/update/UpdateInfo;->url:Ljava/lang/String;

    if-eqz v4, :cond_4

    new-instance v4, Ltms/w;

    iget-object v5, p0, Ltms/gu;->b:Landroid/content/Context;

    invoke-direct {v4, v5}, Ltms/w;-><init>(Landroid/content/Context;)V

    new-instance v5, Ljava/lang/StringBuilder;

    invoke-direct {v5}, Ljava/lang/StringBuilder;-><init>()V

    iget-object v6, p0, Ltms/gu;->c:Ljava/lang/String;
    ...
    invoke-virtual {v4, v5}, Ltms/w;->a(Ljava/lang/String;)V

    iget-object v5, v0, Lcom/tencent/tmsecure/module/update/UpdateInfo;->fileName:Ljava/lang/String;

    invoke-virtual {v4, v5}, Ltms/w;->b(Ljava/lang/String;)V

    new-instance v5, Ltms/gv;

    invoke-direct {v5, p0, v2, v0, v3}, Ltms/gv;-><init>(Ltms/gu;Lcom/tencent/tmsecure/module/update/IUpdateListener$UpdateListener;Lcom/tencent/tmsecure/module/update/UpdateInfo;Ljava/util/concurrent/atomic/AtomicBoolean;)V

    invoke-virtual {v4, v5}, Ltms/w;->a(Ltms/u$a;)V

    new-instance v5, Ljava/lang/StringBuilder;

    invoke-direct {v5}, Ljava/lang/StringBuilder;-><init>()V

    iget-object v6, v0, Lcom/tencent/tmsecure/module/update/UpdateInfo;->url:Ljava/lang/String;

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    const-string v6, "?m=def"
    ...
    invoke-virtual {v4, v5, v7}, Ltms/w;->a(Ljava/lang/String;Z)V
    ...
    invoke-direct {p0, v0}, Ltms/gu;->a(Lcom/tencent/tmsecure/module/update/UpdateInfo;)V
...
.method public b()Ljava/lang/String;
    ...
    iget-object v0, p0, Ltms/gu;->c:Ljava/lang/String;
...
.method public onCreate(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Ltms/gu;->b:Landroid/content/Context;
    ...
    iput-object v0, p0, Ltms/gu;->e:Lcom/tencent/tmsecure/module/wupsession/WupSessionManager;
