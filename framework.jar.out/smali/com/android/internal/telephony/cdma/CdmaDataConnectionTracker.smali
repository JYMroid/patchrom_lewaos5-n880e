...
.method protected constructor <init>(Lcom/android/internal/telephony/cdma/CDMAPhone;)V
    ...
    .line 103
    iput-boolean v1, p0, Lcom/android/internal/telephony/cdma/CdmaDataConnectionTracker;->canSetPreferApn:Z

    .line 104
    iput-object v3, p0, Lcom/android/internal/telephony/cdma/CdmaDataConnectionTracker;->waitingApns:Ljava/util/ArrayList;
...
.method private buildWaitingApns()Ljava/util/ArrayList;
    ...
    iget-object v5, p0, Lcom/android/internal/telephony/cdma/CdmaDataConnectionTracker;->mIccRecords:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    const-string v6, "buildWaitingApns operator: "
    ...
    iget-object v5, p0, Lcom/android/internal/telephony/cdma/CdmaDataConnectionTracker;->mPreferredApn:Lcom/android/internal/telephony/DataProfile;
    ...
    iget-object v7, p0, Lcom/android/internal/telephony/cdma/CdmaDataConnectionTracker;->mPreferredApn:Lcom/android/internal/telephony/DataProfile;
    ...
    iget-object v5, v5, Lcom/android/internal/telephony/DataProfile;->numeric:Ljava/lang/String;
    ...
    invoke-direct {p0, v5}, Lcom/android/internal/telephony/cdma/CdmaDataConnectionTracker;->setPreferredApn(I)V

    .line 311
    const/4 v5, 0x0

    iput-object v5, p0, Lcom/android/internal/telephony/cdma/CdmaDataConnectionTracker;->mPreferredApn:Lcom/android/internal/telephony/DataProfile;
    ...
    invoke-virtual {v0, v5}, Lcom/android/internal/telephony/DataProfile;->canHandleType(Ljava/lang/String;)Z
    ...
    const-string v6, "buildWaitingApns add apn: "
...
.method private getNextApn()Lcom/android/internal/telephony/DataProfile;
    .locals 3
...
.method private getPreferredApn()Lcom/android/internal/telephony/DataProfile;
    ...
    const-string v1, "getPreferredApn: X found DataProfile "
...
.method private isMmsAllowed()Z
    ...
    invoke-virtual {p0}, Lcom/android/internal/telephony/cdma/CdmaDataConnectionTracker;->getMmsOnRoamingEnabled()Z
...
.method private setPreferredApn(I)V
    ...
    const-string v3, "In setPreferredApn pos: "
    ...
    const-string/jumbo v3, "setPreferredApn: insert pos: "
...
.method private setupData(Ljava/lang/String;)Z
    ...
    .line 701
    invoke-direct {p0}, Lcom/android/internal/telephony/cdma/CdmaDataConnectionTracker;->getNextApn()Lcom/android/internal/telephony/DataProfile;
    ...
    .line 703
    const-string/jumbo v4, "setupData: No Appliable Apn found!"
    ...
    invoke-virtual {v1, v2, v3}, Lcom/android/internal/telephony/cdma/CdmaDataConnection;->bringUp(Landroid/os/Message;Lcom/android/internal/telephony/DataProfile;)V
...
.method private trySetupData(Ljava/lang/String;)Z
    ...
    :cond_2
    iget-object v1, p0, Lcom/android/internal/telephony/cdma/CdmaDataConnectionTracker;->mApnType:Ljava/lang/String;
    ...
    invoke-direct {p0}, Lcom/android/internal/telephony/cdma/CdmaDataConnectionTracker;->isMmsAllowed()Z
    ...
    iput-object v1, p0, Lcom/android/internal/telephony/cdma/CdmaDataConnectionTracker;->waitingApns:Ljava/util/ArrayList;
    ...
    .line 598
    const-string/jumbo v1, "trySetupData: No APN found"
    ...
    const-string/jumbo v2, "trySetupData: Create from mAllApns : "
    ...
    invoke-direct {p0, v2}, Lcom/android/internal/telephony/cdma/CdmaDataConnectionTracker;->apnListToString(Ljava/util/ArrayList;)Ljava/lang/String;
    ...
    const-string v2, "Setup watingApns : "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget-object v2, p0, Lcom/android/internal/telephony/cdma/CdmaDataConnectionTracker;->waitingApns:Ljava/util/ArrayList;
...
.method protected createAllApnList()V
    ...
    .line 399
    iget-object v0, p0, Lcom/android/internal/telephony/cdma/CdmaDataConnectionTracker;->mIccRecords:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    :cond_3
    invoke-direct {p0}, Lcom/android/internal/telephony/cdma/CdmaDataConnectionTracker;->getPreferredApn()Lcom/android/internal/telephony/DataProfile;

    move-result-object v0

    iput-object v0, p0, Lcom/android/internal/telephony/cdma/CdmaDataConnectionTracker;->mPreferredApn:Lcom/android/internal/telephony/DataProfile;

    .line 425
    iget-object v0, p0, Lcom/android/internal/telephony/cdma/CdmaDataConnectionTracker;->mPreferredApn:Lcom/android/internal/telephony/DataProfile;
    ...
    iget-object v1, p0, Lcom/android/internal/telephony/cdma/CdmaDataConnectionTracker;->mPreferredApn:Lcom/android/internal/telephony/DataProfile;
...
.method protected getUiccCardApplication()Lcom/android/internal/telephony/IccRecords;
    ...
    .prologue
    .line 1514
    iget-object v0, p0, Lcom/android/internal/telephony/cdma/CdmaDataConnectionTracker;->mUiccController:Lcom/android/internal/telephony/UiccController;

    const/4 v1, 0x2

    invoke-virtual {v0, v1}, Lcom/android/internal/telephony/UiccController;->getIccRecords(I)Lcom/android/internal/telephony/IccRecords;
...
.method protected onApnChanged()V
    ...
    .line 1432
    const-string v4, "In onApnChanged"
    ...
    :goto_0
    iget-object v4, p0, Lcom/android/internal/telephony/cdma/CdmaDataConnectionTracker;->mIccRecords:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-virtual {v4, v1}, Lcom/android/internal/telephony/cdma/CDMAPhone;->updateCurrentCarrierInProvider(Ljava/lang/String;)Z

    .line 1443
    invoke-virtual {p0}, Lcom/android/internal/telephony/cdma/CdmaDataConnectionTracker;->createAllApnList()V
    ...
    const-string/jumbo v5, "onApnChanged mState: "
    ...
    .line 1447
    const-string/jumbo v3, "onApnChanged mPreferredApn mActiveApn same "
    ...
    .end local v2           #r:Lcom/android/internal/telephony/IccRecords;
    :cond_1
    move v0, v3
    ...
    .restart local v2       #r:Lcom/android/internal/telephony/IccRecords;
    :cond_2
    const-string v1, ""
    ...
    invoke-virtual {p0, v0, v4, v3}, Lcom/android/internal/telephony/cdma/CdmaDataConnectionTracker;->cleanUpConnection(ZLjava/lang/String;Z)V
    ...
    invoke-virtual {v3}, Lcom/android/internal/telephony/DataConnection;->resetRetryCount()V

    .line 1457
    const-string/jumbo v3, "onApnChanged trySetupData reason: REASON_APN_CHANGED"
...
.method protected onDataSetupComplete(Landroid/os/AsyncResult;)V
    ...
    const-string v9, "PREFERRED canSetPreferApn: "

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v8

    iget-boolean v9, p0, Lcom/android/internal/telephony/cdma/CdmaDataConnectionTracker;->canSetPreferApn:Z
    ...
    .line 1072
    iget-boolean v8, p0, Lcom/android/internal/telephony/cdma/CdmaDataConnectionTracker;->canSetPreferApn:Z

    if-eqz v8, :cond_1

    iget-object v8, p0, Lcom/android/internal/telephony/cdma/CdmaDataConnectionTracker;->mPreferredApn:Lcom/android/internal/telephony/DataProfile;
    ...
    const-string v9, "PREFERRED APN is null mActiveApn: "

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v8

    iget-object v9, p0, Lcom/android/internal/telephony/cdma/CdmaDataConnectionTracker;->mActiveApn:Lcom/android/internal/telephony/DataProfile;
    ...
    iput-object v8, p0, Lcom/android/internal/telephony/cdma/CdmaDataConnectionTracker;->mPreferredApn:Lcom/android/internal/telephony/DataProfile;

    .line 1075
    iget-object v8, p0, Lcom/android/internal/telephony/cdma/CdmaDataConnectionTracker;->mPreferredApn:Lcom/android/internal/telephony/DataProfile;

    iget v8, v8, Lcom/android/internal/telephony/DataProfile;->id:I

    invoke-direct {p0, v8}, Lcom/android/internal/telephony/cdma/CdmaDataConnectionTracker;->setPreferredApn(I)V

    .line 1080
    :cond_1
    iget v8, p0, Lcom/android/internal/telephony/cdma/CdmaDataConnectionTracker;->mCidActive:I
    ...
    invoke-direct {v5, v8, v9, v10}, Landroid/net/ProxyProperties;-><init>(Ljava/lang/String;ILjava/lang/String;)V
    ...
    const-string/jumbo v9, "onDataSetupComplete: NumberFormatException making ProxyProperties ("

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v8

    iget-object v9, v0, Lcom/android/internal/telephony/ApnSetting;->port:Ljava/lang/String;
    ...
    invoke-virtual {p0, v8}, Lcom/android/internal/telephony/cdma/CdmaDataConnectionTracker;->loge(Ljava/lang/String;)V
    ...
    invoke-virtual {v8}, Lcom/android/internal/telephony/DataConnection;->isRetryNeeded()Z
    ...
    .line 1124
    invoke-virtual {p0, v11}, Lcom/android/internal/telephony/cdma/CdmaDataConnectionTracker;->notifyOffApnsOfAvailability(Ljava/lang/String;)V

    .line 1125
    invoke-direct {p0, v1, v6, v7}, Lcom/android/internal/telephony/cdma/CdmaDataConnectionTracker;->reconnectAfterFail(Lcom/android/internal/telephony/DataConnection$FailCause;Ljava/lang/String;I)V

    goto/16 :goto_1

    .line 1127
    :cond_8
    invoke-direct {p0, v1, v6, v7}, Lcom/android/internal/telephony/cdma/CdmaDataConnectionTracker;->startDelayedRetry(Lcom/android/internal/telephony/DataConnection$FailCause;Ljava/lang/String;I)V
...
.method protected onUpdateIcc()V
    ...
    .line 1519
    iget-object v2, p0, Lcom/android/internal/telephony/cdma/CdmaDataConnectionTracker;->mUiccController:Lcom/android/internal/telephony/UiccController;
